        ...
        return(
            <div className="form-group row">
                <div className="col-sm-10">
                    ...
                    <button type = "button" onClick={()=> {this.props.addTodo(this.state.todotext); this.setState({todotext:""})}} style={{marginTop: "25px"}} className="btn btn-succes">Add Todo</button>
                </div>
            </div>
        );
    }
